...
import { LegalToc, LegalSections, type LegalSection } from "@/components/LegalToc";
...
const sections: LegalSection[] = [
    ...
    body: (
      <>
        <p>
          ...
          when you use our website or app, how we use it, who we share it
      ...
      <>
        ...
        <ul className="list-disc space-y-2 pl-5">
          <li>
            ...
            employment and income details, PAN, Aadhaur number, and bank
            account information submitted during onboarding or KYC.
          </li>
          <li>
            <span className="font-medium text-ink">Collected automatically</span>
            {" — "}device identifiers, IP address, app usage patterns, log
            files, and location (if permission is granted) used to secure
            your account and improve the product.
          </li>
          <li>
            <span className="font-medium text-ink">Received from third parties</span>
  ...
  },
  {
    ...
    body: (
      <ul className="list-disc space-y-2 pl-5">
        ...
        <li>
          To communicate updates about your application, EMI schedule, or
          account via SMS, email, WhatsApp, or push notification.
        </li>
        <li>To detect and prevent fraud, and to comply with legal and regulatory obligations.</li>
        <li>
      ...
      <>
        ...
        <ul className="list-disc space-y-2 pl-5">
          <li>
            ...
            that sanctions and disburses your loan, receives the details
            needed to underwrite and service it.
          </li>
          <li>
            <span className="font-medium text-ink">Credit bureaus</span>
            {" — "}your loan and repayment data is reported to bureaus such
            as CIBIL, Experian, Equifax and CRIF as mandated by RBI
            regulation.
          </li>
          <li>
          ...
          <li>
            <span className="font-medium text-ink">Regulators and law enforcement</span>
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        accessed only by authorized systems for KYC verification. While we
        work to protect your data, no method of transmission or storage is
        100% secure, and we encourage you to keep your login credentials
        confidential.
      </p>
    ),
  },
  {
    ...
    body: (
      <ul className="list-disc space-y-2 pl-5">
        <li>Access and download a copy of the personal data we hold about you.</li>
        <li>Request correction of inaccurate or incomplete information.</li>
        <li>
          Withdraw consent for marketing communications at any time via the
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        in, remember your preferences, and understand how the site is used.
        You can control cookies through your browser settings; disabling
        them may limit some features of the site.
      </p>
    ),
  },
  {
    ...
    body: (
      <p>
        ...
        guidelines, applicable tax and accounting laws, and to resolve
        disputes or enforce our agreements — typically up to 8 years after
        loan closure.
      </p>
    ),
  },
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        of material changes through the app or by email, and the &ldquo;last
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        <a href="mailto:privacy@fundsontime.in" className="font-medium text-azure-600 underline underline-offset-2">
